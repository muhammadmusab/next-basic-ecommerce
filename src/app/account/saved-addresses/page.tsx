...
import AddEditAddress from "@/components/account/profile/add-edit-address";
  ...
  return (
    <Fragment>
      <div className="flex justify-between mb-4 sm:flex-col">
        ...
        <AddEditAddress mode="add" triggerButtonClass="!w-[200px] !mt-0 sm:!w-full" />
      </div>
      {addresses.map((item) => (
        <div
          key={item.id}
        ...
        >
          ...
          <div className="flex flex-col sm:w-full sm:mt-[20px]">
            <button className="mb-2 transition-all bg-primary font-roboto font-bold text-white py-10 px-[65px] md:px-[30px] hover:bg-primaryhover">
              REMOVE
            </button>
