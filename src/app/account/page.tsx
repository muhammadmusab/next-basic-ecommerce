...
import { FaRotateRight, FaLocationDot } from "react-icons/fa6";
...
const Dashboard = () => {
  const sections = [
    ...
    // {
    //   text: "Returns",
    //   icon: <FaRotateRight className="text-[40px] text-gray-800" />,
    //   path: "/account/orders",
    // },
    {
      text: "Addresses",
    ...
    // {
    //   text: "Coupons",
    //   icon: <RiCouponLine className="text-[40px] text-gray-800" />,
  ...
  return (
    <Fragment>
      <div className="bg-[#f8f9fa] p-[1rem] w-full flex items-center justify-between border border-[#ccc] xs:flex-col xs:w-full xs:items-start">
        <p className="m-0">michel@example.com</p>
        <button className="flex items-center bg-transparent border border-black hover:bg-black transition-all duration-500 hover:text-white p-2 xs:mt-[10px]">
          <FaPencilAlt />
